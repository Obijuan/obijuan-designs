...
# EDIT THIS!
user = "obijuan" # User from Thingiverse (as in the profile URL)
authorName = "Juan Gonzalez-Gomez (Obijuan)" # Any string is OK
authorDescription = "<http://www.iearobotics.com/wiki/index.php?title=Juan_Gonzalez:Main>"
